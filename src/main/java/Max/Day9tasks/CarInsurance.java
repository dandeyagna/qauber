...
//	}
	...
	public void printCarReport() {
		...
		System.out.println("Due to the above factors, we calculated his driver rating at " + driverRating + "/100 and therefore this person has qualified for a monthly payment of $" + carPayment);
		//return lifeReport;
	}	
